...
export const RESEARCH_INTERESTS: ResearchInterest[] = [
  ...
  },
  {
    ...
    description:
      "Studying how to make aligned behavior remain stable under adversarial inputs, distribution shifts, and reward imperfections. Models that appear aligned in standard settings may fail when exposed to jailbreaks or strategic prompt manipulation. This direction focuses on understanding why alignment breaks under stress and how training or inference-time mechanisms can improve robustness in realistic deployment scenarios.",
    period: "2025.6 - until now",
