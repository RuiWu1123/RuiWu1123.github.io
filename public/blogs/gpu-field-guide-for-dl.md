...
![CPU vs GPU chip layout](blogs/images/cpu-vs-gpu.svg)
...
![Inside one Streaming Multiprocessor](blogs/images/gpu-sm-anatomy.svg)
...
![GPU memory hierarchy](blogs/images/memory-hierarchy.svg)
...
![Matmul tiling diagram](blogs/images/matmul-tiling.svg)
...
![Multi-GPU topology](blogs/images/multi-gpu-topology.svg)
